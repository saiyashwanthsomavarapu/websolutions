...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <SEO 
        title="Privacy Policy | Aadhya Web Solution"
        description="Read our privacy policy to understand how Aadhya Web Solution collects, uses, and protects your personal information when you visit our website or use our services."
        keywords="privacy policy, aadhya web solution privacy, data protection, website privacy, personal information protection"
        canonical="https://aadhyawebsolution.com/privacy"
      />
      <Space
        style={{
          display: "flex",
