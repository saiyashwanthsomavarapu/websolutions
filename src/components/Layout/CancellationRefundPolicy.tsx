...
const CancellationRefundPolicy = () => {
  ...
  return (
    <>
      <SEO 
        title="Cancellation and Refund Policy | Aadhya Web Solution"
        description="Learn about our cancellation and refund policy at Aadhya Web Solution. We strive to provide high-quality services and clear refund processes for our clients."
        keywords="cancellation policy, refund policy, aadhya web solution refund, service cancellation, money back guarantee"
        canonical="https://aadhyawebsolution.com/refund"
      />
      <Space
        style={{
          display: "flex",
